  ...
  <div class="container-fluid ">
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a>Generar Lista de Deserción Escolar</a>
      </li>
      <li class="breadcrumb-item active">Seleccione los campos correspondientes para generar lista de deserción escolar</li>
    </ol>


    <form class="card" id="formulario" action="<?php echo base_url();?>/C_estudiante/generar_lista_desercion" target="_blank" method='post'>
      <div class="card-body">
          ...
          <div class="col-md-6">
            ...
            <div class="col-md-6 ">
                ...
                <button type="submit" class="btn btn-success btn-lg btn-block" style=""
                                id="crear_grupo">Generar reporte de deserción escolar</button>
